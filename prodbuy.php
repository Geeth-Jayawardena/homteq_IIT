...
echo "<title>" . "A smart buy for a smart home" . "</title>"; //display name of the page as window title

echo "<body>";

include("headfile.html"); //include header layout file 

echo "<h4>" . "A smart buy for a smart home" . "</h4>"; //display name of the page on the web page
